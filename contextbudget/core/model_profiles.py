...
from contextbudget.core.tokens import builtin_token_estimator_plugin_name
from contextbudget.schemas.models import ModelProfileReport
...
def _apply_compression_strategy_defaults(config: ContextBudgetConfig, strategy: CompressionStrategyDefaults) -> None:
...
) -> tuple[ContextBudgetConfig, dict[str, Any]]:
