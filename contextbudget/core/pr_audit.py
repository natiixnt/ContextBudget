...
from contextbudget.plugins.registry import ResolvedPlugins
from contextbudget.scanners.git_diff import collect_pull_request_diff
...
def _build_local_python_modules(repo: Path, config: ContextBudgetConfig) -> set[str]:
