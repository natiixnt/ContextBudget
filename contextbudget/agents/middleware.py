...
def prepare_context(
    ...
    *,
    ...
    active_middleware = middleware if middleware is not None else ContextBudgetMiddleware(config_path=config_path)
...
def record_run(
    ...
    *,
    ...
    active_middleware = middleware if middleware is not None else ContextBudgetMiddleware()
