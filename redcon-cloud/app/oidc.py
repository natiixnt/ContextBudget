...
"""OIDC / JWT authentication for the Redcon Cloud control plane.

Configuration (environment variables)
--------------------------------------
RC_CLOUD_OIDC_ISSUER      OIDC issuer URL, e.g. https://accounts.google.com
                           or https://mycompany.okta.com/oauth2/default
RC_CLOUD_OIDC_AUDIENCE    Expected `aud` claim in the JWT (your app's client ID)
RC_CLOUD_OIDC_JWKS_URI    (optional) Override the JWKS URI; defaults to
                           {issuer}/.well-known/jwks.json
RC_CLOUD_OIDC_ENABLED     Set to "true" to enable OIDC auth (default: false)
...
_ISSUER: str = os.getenv("RC_CLOUD_OIDC_ISSUER", "")
