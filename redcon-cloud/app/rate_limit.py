...
via the ``RC_CLOUD_EVENTS_RATE_LIMIT`` and ``RC_CLOUD_EVENTS_RATE_WINDOW``
...
_LIMIT: int = int(os.getenv("RC_CLOUD_EVENTS_RATE_LIMIT", "500"))
_WINDOW: int = int(os.getenv("RC_CLOUD_EVENTS_RATE_WINDOW", "60"))  # seconds
