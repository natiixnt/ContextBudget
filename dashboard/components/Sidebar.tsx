...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-56 bg-sidebar flex flex-col z-10">
      {/* Logo */}
      <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-700/50">
        <div className="w-8 h-8 rounded-lg bg-accent flex items-center justify-center flex-shrink-0">
          <svg width="18" height="18" viewBox="0 0 28 28" fill="none">
            <rect x="3" y="17" width="4" height="7" rx="1" fill="white" />
            <rect x="10" y="11" width="4" height="13" rx="1" fill="white" />
            <rect x="17" y="5" width="4" height="19" rx="1" fill="white" />
