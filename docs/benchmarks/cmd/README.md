...
|--------|----------|----------------|-------------------------|----------------|----------------|
| [bundle_stats](./bundle_stats.md) | 1 | 794 | +83.5% | 0.05 ms | 0.05 ms |
...
| [find](./find.md) | 2 | 1,705 | +19.8% | 0.42 ms | 0.42 ms |
| [git_diff](./git_diff.md) | 2 | 4,069 | +79.0% | 0.47 ms | 0.46 ms |
...
| [grep](./grep.md) | 2 | 3,517 | +26.7% | 0.66 ms | 0.66 ms |
| [json_log](./json_log.md) | 1 | 6,014 | +91.2% | 1.69 ms | 1.61 ms |
| [kubectl_get](./kubectl_get.md) | 1 | 176 | +47.7% | 0.05 ms | 0.05 ms |
| [lint](./lint.md) | 2 | 962 | +79.9% | 0.29 ms | 0.27 ms |
| [ls](./ls.md) | 2 | 792 | +47.2% | 0.69 ms | 0.51 ms |
| [npm_test](./npm_test.md) | 1 | 68 | +48.5% | 0.02 ms | 0.02 ms |
| [pkg_install](./pkg_install.md) | 1 | 171 | +84.2% | 0.03 ms | 0.03 ms |
| [profiler](./profiler.md) | 1 | 2,366 | +89.2% | 0.44 ms | 0.49 ms |
| [pytest](./pytest.md) | 2 | 1,381 | +79.4% | 0.28 ms | 0.31 ms |
| [sql_explain](./sql_explain.md) | 1 | 421 | +70.3% | 0.15 ms | 0.14 ms |
